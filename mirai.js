...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), 'BANNED'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/nguyencuongthinh/tobi/mainV2/listgban.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/nguyencuongthinh/tobi/mainV2/listgban.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/tobi/GbanMirai/mainV2/data.json').then(json => {
