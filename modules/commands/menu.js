 ...
 const timeNow = moment.tz("Asia/Ho_Chi_Minh").format("HH:mm:ss - DD/MM/YYYY");
  ...
  const {
    ...
    if (type) {
        ...
        api.sendMessage({body: msg1 + msg, attachment: (await require('axios').get(`https://i.imgur.com/0lAqQoj.jpg`, {
        responseType: 'stream'
    })).data
...
if (event.reaction != "❤") return; 
 api.unsendMessage(handleReaction.messageID);
        ...
        return api.sendMessage({body: msg, attachment: (await require('axios').get(`https://i.imgur.com/0lAqQoj.jpg`, {
        responseType: 'stream'
    })).data
},event.threadID); 
  }
